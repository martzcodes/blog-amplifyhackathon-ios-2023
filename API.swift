...
public struct ModelSubscriptionNoteDataFilterInput: GraphQLMapConvertible {
  public var graphQLMap: GraphQLMap

  public init(id: ModelSubscriptionIDInput? = nil, name: ModelSubscriptionStringInput? = nil, description: ModelSubscriptionStringInput? = nil, image: ModelSubscriptionStringInput? = nil, and: [ModelSubscriptionNoteDataFilterInput?]? = nil, or: [ModelSubscriptionNoteDataFilterInput?]? = nil) {
  ...
  public var and: [ModelSubscriptionNoteDataFilterInput?]? {
    get {
      return graphQLMap["and"] as! [ModelSubscriptionNoteDataFilterInput?]?
    }
    set {
      graphQLMap.updateValue(newValue, forKey: "and")
    }
  ...
  public var or: [ModelSubscriptionNoteDataFilterInput?]? {
    get {
      return graphQLMap["or"] as! [ModelSubscriptionNoteDataFilterInput?]?
    }
    set {
      graphQLMap.updateValue(newValue, forKey: "or")
    }
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct ListNoteDatum: GraphQLSelectionSet {
      ...
      public init(items: [Item?], nextToken: String? = nil) {
        self.init(snapshot: ["__typename": "ModelNoteDataConnection", "items": items.map { $0.flatMap { $0.snapshot } }, "nextToken": nextToken])
      }
